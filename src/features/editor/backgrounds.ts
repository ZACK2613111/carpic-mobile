...
// Professional-first ordering: transparent + neutrals + studio scenes lead the
// strip; the louder consumer gradients (Ocean/Sunset…) come last. The app is a
// serious listing tool, so the studio looks are what a seller reaches for first.
